...
The public frontend uses React and TypeScript with Vite to provide a maintainable, type-checked foundation for the
production platform.
**Why it matters:**
React provides a component-based model for building the interface, while TypeScript catches many errors before
